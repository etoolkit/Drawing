...
//	SHBindToParent( (LPCITEMIDLIST) pidl, IID_IShellFolder, (void **) &m_psfFolder, (LPCITEMIDLIST*) &pidlItem);	
	HRESULT hres = SHBindToParentEx (pidl, IID_IShellFolder, (void**)&m_psfFolder, (LPCITEMIDLIST*)&pidlItem);
	//LPMALLOC lpMalloc = NULL;
	//HRESULT htmp= SHGetMalloc (&lpMalloc);

	m_pidlArray = (LPITEMIDLIST *) malloc (sizeof (LPITEMIDLIST));	// allocate ony for one elemnt
	//m_pidlArray = (LPITEMIDLIST *) lpMalloc->Alloc(sizeof(LPITEMIDLIST));
