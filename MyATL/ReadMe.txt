...
应用程序向导已为您创建了此 MyATL 项目，作为编写动态链接库 (DLL) 
的起点。
...
MyATL.h
    此文件包含 MyATL.idl 中定义的项目的 C++ 接口定义
...
StdAfx.h，StdAfx.cpp
    这些文件用于生成名为 MyATL.pch 的预编译头 (PCH) 文件和
...
MyATLps.vcxproj
    ...
    文件。此进程生成 dlldata.c、MyATL_i.c 和 
    MyATL_p.c，这些文件是生成代理/存根 (stub) DLL 所必需的。

MyATLps.vcxproj.filters
